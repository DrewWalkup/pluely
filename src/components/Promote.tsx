...
const STORAGE_KEY = "nyx-promote-card-dismissed";
			...
			<CardContent className="flex flex-col gap-4 p-4 py-0 md:flex-row md:items-center md:justify-between">
				<div className="space-y-2 md:max-w-[70%]">
					<CardTitle className="text-xs lg:text-sm">
						Promote Nyx, Earn Rewards
					</CardTitle>
					<CardDescription className="text-[10px] lg:text-xs">
						Share Nyx on social, hit 5K impressions, and we&apos;ll
						send you a $5&ndash;$10 coupon for a monthly plan. Email
						your post link to{" "}
						<a
				...
				<Button
					asChild
					className="w-full md:w-auto text-[10px] lg:text-xs"
				>
					<a
						href="https://nyx.com/promote"
